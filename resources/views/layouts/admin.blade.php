...
<html lang="id">
    <head>
        ...
        <title>@yield('title', 'Admin PromoDiskon')</title>
            ...
            <aside class="admin-sidebar">
                ...
                <div class="admin-sidebar-footer">
                    <div class="admin-user-info">
                        <div class="admin-avatar-sm">{{ strtoupper(substr($adminName, 0, 1)) }}</div>
                    ...
                    <div class="admin-footer-actions">
                        <a class="btn-sidebar-action btn-sidebar-home" href="{{ route('home') }}">
            ...
            <div class="admin-content">
                <header class="admin-topbar">
                    <div>
                        ...
                        <p>@yield('page-desc', 'Ringkasan promosi dan pengunjung.') </p>
                    </div>
