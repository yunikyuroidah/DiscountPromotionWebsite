...
<html lang="id">
    <head>
        ...
        <title>@yield('title', 'PromoDiskon Elektronik')</title>
    ...
    <body class="page-public" data-page="public">
        ...
        <header class="site-header">
            <div class="container nav-bar">
                <a class="brand" href="{{ route('home') }}">PromoDiskon</a>
                <nav class="nav-links">
                    <a href="{{ route('home') }}" class="{{ request()->routeIs('home') ? 'active' : '' }}">Beranda</a>
                    <a href="{{ route('promo') }}" class="{{ request()->routeIs('promo') ? 'active' : '' }}">Promosi</a>
                </nav>
            </div>
        </header>
